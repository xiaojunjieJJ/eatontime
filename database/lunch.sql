...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`category` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`combo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`combo_dish` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`user` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`cart` ;
...
CREATE TABLE IF NOT EXISTS `eatontime`.`cart` (
  ...
  `price` DECIMAL(6,2) NULL COMMENT '单价',
  `create_time` DATETIME NULL COMMENT '创建时间',
  `update_time` DATETIME NULL COMMENT '修改时间',
  `del_flag` TINYINT NULL DEFAULT 0 COMMENT '删除标志',
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`order` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`order_item` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`address` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eatontime`.`manager` ;
